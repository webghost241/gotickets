...
class BlogPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_post" do
    assert_difference("BlogPost.count") do
      post blog_posts_url, params: { blog_post: { content: @blog_post.content, title: @blog_post.title, user_id: @blog_post.user_id } }
    end
  ...
  test "should update blog_post" do
    patch blog_post_url(@blog_post), params: { blog_post: { content: @blog_post.content, title: @blog_post.title, user_id: @blog_post.user_id } }
